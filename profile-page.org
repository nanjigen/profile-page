...
This step sets up the Google Cloud CLI on the runner. It uses a pre-built action [[https://github.com/google-github-actions/setup-gcloud][google-github-actions/setup-gcloud]] =@main= provided by Google. The =with= section provides configuration:
